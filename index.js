...
// add event listener that filters games as user types
searchBar.addEventListener("input", function() {
    
    // get the current value of the search bar in lowercase
    ...
    // clear the current games and display search results
    deleteChildElements(gamesContainer);
